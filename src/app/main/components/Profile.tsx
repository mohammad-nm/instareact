...
export default function Profile() {
  ...
  return (
    <button
      className="mt-4 ml-4  p-2 rounded-md text-white bg-[#0A0A0A] [box-shadow:#666666_0px_0px_0px_1px]"
    ...
    >
      {!instagram.token?.LLToken ? (
        ...
        <>
          ...
          {isOpen && (
            <div className="w-fit bg-black rounded-lg text-white py-1 px-3 mt-2 mx-auto">
              LogOut
            </div>
          )}
        </>
